...
@Component(role = DataHandler.class, hint = ProfileTriggerProvided.CANONICAL_NAME)
public class ProfileProvidedTriggerDataHandler extends ADataHandler {
	...
	protected PlexusConfiguration toConfig(final ConfigurationFactory<PlexusConfiguration> factory,
		...
		final ProfileTriggerProvided data = (ProfileTriggerProvided) entry;
		final PlexusConfiguration cnf = factory.create(ProfileTriggerProvided.HINT);
