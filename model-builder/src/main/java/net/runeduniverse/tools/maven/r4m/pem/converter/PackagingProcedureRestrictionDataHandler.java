...
@Component(role = DataHandler.class, hint = PackagingProcedureRestriction.CANONICAL_NAME)
public class PackagingProcedureRestrictionDataHandler extends ADataHandler {
	...
	protected PlexusConfiguration toConfig(final ConfigurationFactory<PlexusConfiguration> factory,
		...
		final PackagingProcedureRestriction data = (PackagingProcedureRestriction) entry;
		final PlexusConfiguration cnf = factory.create(PackagingProcedureRestriction.HINT);

		setValueAsId(cnf, data.getPackagingProcedure());
