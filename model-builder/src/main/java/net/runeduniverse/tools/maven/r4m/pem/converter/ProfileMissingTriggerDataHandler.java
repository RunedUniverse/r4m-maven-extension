...
@Component(role = DataHandler.class, hint = ProfileTriggerMissing.CANONICAL_NAME)
public class ProfileMissingTriggerDataHandler extends ADataHandler {
	...
	protected PlexusConfiguration toConfig(final ConfigurationFactory<PlexusConfiguration> factory,
		...
		final ProfileTriggerMissing data = (ProfileTriggerMissing) entry;
		final PlexusConfiguration cnf = factory.create(ProfileTriggerMissing.HINT);
