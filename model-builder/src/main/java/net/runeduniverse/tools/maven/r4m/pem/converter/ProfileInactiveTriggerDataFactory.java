...
@Component(role = DataFactory.class, hint = ExecutionTrigger.CONTEXT + '>' + ProfileTriggerInactive.HINT)
public class ProfileInactiveTriggerDataFactory extends ADataFactory {

	@Override
	public DataEntry createEntry(final PlexusConfiguration cnf) {
		if (!ProfileTriggerInactive.HINT.equals(cnf.getName()))
			return null;
