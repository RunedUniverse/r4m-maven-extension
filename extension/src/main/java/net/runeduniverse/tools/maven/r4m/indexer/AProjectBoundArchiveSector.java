...
public abstract class AProjectBoundArchiveSector<S extends ProjectBoundArchiveSector<S>>
		implements ProjectBoundArchiveSector<S> {

	protected final MavenProject mvnProject;

	protected S parent;

	public AProjectBoundArchiveSector(final MavenProject mvnProject) {
