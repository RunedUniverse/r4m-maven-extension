...
@Component(role = ExecutionTriggerWriter.class, hint = ProfileTriggerProvided.CANONICAL_NAME)
public class ProfileTriggerProvidedWriter implements ExecutionTriggerWriter {
	...
	public boolean append(final PlexusConfiguration triggerNode, final ExecutionTrigger trigger) {
		...
		final PlexusConfiguration node = triggerNode.getChild(ProfileTriggerProvided.HINT, true);
