...
@Component(role = DataFactory.class, hint = ExecutionTrigger.CONTEXT + '>' + ProfileTriggerMissing.HINT)
public class ProfileMissingTriggerDataFactory extends ADataFactory {

	@Override
	public DataEntry createEntry(final PlexusConfiguration cnf) {
		if (!ProfileTriggerMissing.HINT.equals(cnf.getName()))
			return null;
