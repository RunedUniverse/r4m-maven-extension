...
@Component(role = DataFactory.class, hint = ExecutionTrigger.CONTEXT + '>' + ProfileTriggerProvided.HINT)
public class ProfileProvidedTriggerDataFactory extends ADataFactory {

	@Override
	public DataEntry createEntry(final PlexusConfiguration cnf) {
		if (!ProfileTriggerProvided.HINT.equals(cnf.getName()))
			return null;
